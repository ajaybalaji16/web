...
public class loan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException
    {
     String get=request.getParameter("entry");
     if(get.equalsIgnoreCase("home"))
     {
         RequestDispatcher rd=request.getRequestDispatcher("homeloan.jsp");
         rd.forward(request, response);
     }
     if(get.equalsIgnoreCase("education"))
     {
