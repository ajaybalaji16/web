...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        ...
        <br></br>
        <form action="a_newaccount.jsp" method="post" name="search">
    ...
    <%
        try
        {
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                if(rs.next()){
                    %>
                    <center><table align="center" width="300" >
                            <tr align="center">
    ...
    <tr align="center">
        ...
        <td align="center"><button value="<%=rs.getString(10)%>" name="accountno">View</td>
    </tr>
