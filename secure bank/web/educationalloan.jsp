...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        <center><h1>Educational Loan</h1></center>
        <br></br>
                     <center><form name="myForm" method="post" action="education" >
                ...
                <tr>
                    ...
                    <td><input type="text" name="mobileno" placeholder="xxxxxxrs" onkeypress="return isNumberkey(event)" required="" /></td>
                </tr>
                <tr> <td>&nbsp;</td> </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="account" pattern="[0-9]{10}">
                    </td>
                </tr> 
                            <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td>  <p class="italic">Address: </p></td>
                    <td><textarea rows="4"  name="address" cols="20" placeholder="present"></textarea>
            
                    </td>
                </tr>
                            <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Place of Study: </p></td>
                    <td><input type="text" name="placeofstudy" /></td>
                </tr> 
                            <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Time of Study: </p></td>
                    <td>From<input type="date" name="from" size="50"/></td></tr>
                            <tr> <td></td><td>   To   <input type="date" name="to" size="50"/></td>
                </tr>
                            <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Loan Amount: </p></td>
                    <td><input type="number" name="loanamount" /></td>
                </tr>
                            <tr> <td>&nbsp;</td> </tr>
                       <tr>
                           <td> <p class="italic">Admission Secured:</p> </td>
                    <td><input type="radio" name="get" value="yes" checked="" />Yes
                    <input type="radio" name="get" value="no" checked="" />No</td>
                </tr>                     
  ...
  <table id="myTable">
      <tr><td></td><td><input type="submit" value="Enter" style="background-color: #008dde;height:40px; width:120px;color: white"></td></tr>
   </table>
                         </form></center>
