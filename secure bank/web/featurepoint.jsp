...
<!--        <form id="formsearch" name="formsearch" method="post" action="#">
      ...
      <div class="menu_nav">
        ...
        <li ><a href="home.jsp"><span>Home</span></a></li>
          ...
          <li style="padding-left: 400px;;" ><a href="login.jsp"><span>Logout</span></a></li>  <!--<li><a href="contact.html"><span>Contact Us</span></a></li>-->
        </ul>
      </div>
      <div class="clr"></div>
<!--      <div class="slider">
...
<center>
                    <form name="myform" enctype="multipart/form-data">
                        <h1>Pick anyone of  your image</h1>
                        <br></br>
                        <center><table width="500px" >
                            <tr> 
                                 <td>  <a href="choosepoint.jsp" id="bottle" onclick="document.location='login_choosepoint.jsp';return false;" >
                                         <img src="ImageServlet" width="167" height="117" alt="bottle" border="3"/></a></td>

                                <!--<td><img src="ImageServlet" width="167" height="117" onclick="choosepoint.jsp"></img></td>-->
<!--                                <form action="additionalImg" enctype="multipart/form-data">
                                    <table><tr>-->
                                         <td></td><td>
                                             <a href="choosepoint.jsp" id="bottle1" onclick="document.location='index.html';return false;" >
                                                 <img src="additionalImg" width="167" height="117" border="3"></img></a></td></tr>
