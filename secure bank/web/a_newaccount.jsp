...
<!--        <form id="formsearch" name="formsearch" method="post" action="#">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="a_newaccount1.jsp"><span>New Account</span></a></li>
          <li><a href="searchaccount.jsp"><span>Account Details</span></a></li>
          <li><a href="a_fixeddeposit.jsp"><span>Fixed Deposit</span></a></li>
           <li><a href="a_beneficiary.jsp"><span>Beneficiary</span></a></li>
...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        <center><h1>Newly Registered Accounts</h1></center>
        <br></br>
        <form name="form1" action="allow" method="post" enctype="multipart/form-data" autocomplete="false">
    <center><table width="500" align="center" height="300">
    <%
    ...
    <tr align="center">
        ...
        <td><h4><%=accountno%></h4></td>
    </tr>
    <tr align="center">
        <td><h3>Bank Name</h3></td>
        <%String bankname=rs.getString(13);%>
        <td><h4><%=bankname%></h4></td>
    </tr>
    <tr align="center">
        <td><h3>Branch Name</h3></td>
        <%String branchname=rs.getString(14);%>
        <td><h4><%=branchname%><h4></td>
    </tr>
    ...
    <tr align="center">
        <td><h3>Balance:</h3></td>
        <td><input type="text" name="amount" onkeypress="return checkInp()" autocomplete="off" required></td>
    </tr>
    <tr align="center">
        <td><h3>Choose any image</h3></td>
        <td><input type="file" name="photo" accept="image/*" size="50" required style="width: 155px"/></td>
    </tr>
        </table></center>
    <%
...
<center><input type="submit" value="ALLOW" style="background-color: #008dde;height:40px; width:120px;color: white" name="allow"></center>
</form>
