...
<center>
                    <form name="myform" action="ImageServlet" enctype="multipart/form-data">
                        <h1>Choose your image feature point</h1>
                        <br></br>
                        <center>  <table width="700px">
                                <tr><td width="233px"></td> 
                                <td><img src="ImageServlet" width="242" height="187" border="3"></td>
                                <!--<td><img src="additionalImg" width="167" height="117"></img></td>-->
                            </tr>
                           </table>
                        </center>
                            </form></center>
