...
<!--      <div class="searchform">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="searchaccount.jsp"><span>Account Details</span></a></li>
          <li><a href="a_fixeddeposit.jsp"><span>Fixed Deposit</span></a></li>
          <li><a href="a_beneficiary.jsp"><span>Beneficiary</span></a></li>
          <li style="padding-left: 260px;;"><a href="a_login.jsp"><span>Logout</span></a></li>
...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
       <form action="a_account.jsp">
<center><table width="400" height="100">
    <tr><td><h3>Search Account</h3></td>
        <td><input type="text" name="accountno" pattern="[0-9]{10}"></td>
        <td></td><td><input type="submit" value="submit" style="background-color: #008dde;color: white" ></td></tr>
    </table></center>
           <center>   <table border="1" width="700" align="center"><tr>
         ...
         <%
                ...
                while(rs.next())
                {
                    if(rs.getString(10).equalsIgnoreCase("1234561111"))
                    {
                        continue;
                    }
         %>
...
<!--//                    <h3>No accounts are available</h3>-->
 </table></center> 
                <%
//                     }
                  }
