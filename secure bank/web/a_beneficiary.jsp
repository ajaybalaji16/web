...
<!--        <form id="formsearch" name="formsearch" method="post" action="#">
      ...
      <div class="menu_nav">
        <ul>
          <li><a href="a_home.jsp"><span>Home</span></a></li>
          <li><a href="a_newaccount1.jsp"><span>New Account</span></a></li>
          <li><a href="searchaccount.jsp"><span>Account Details</span></a></li>
          <li><a href="a_fixeddeposit.jsp"><span>Fixed Deposit</span></a></li>
           <li class="active"><a href="a_beneficiary.jsp"><span>Beneficiary</span></a></li>
          <li style="padding-left: 260px;"><a href="login.jsp"><span>Logout</span></a></li>
...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        <h1 align="center">Beneficiary Details</h1>
        <br></br>
        <form action="b_allow" method="post" name="search">
    ...
    <%
        ...
        {                       
            Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet rs=st.executeQuery("select * from beneficiary where statuss='disable'");
                if(rs.next()){
                    %>
                    <center><table align="center" width="500" >
                            <tr align="center">
                                <td align="center"> <h4>B Name</h4>  </td>
                                <td align="center"> <h4>B Account No</h4>  </td>
                                <td align="center"><h4>Account No</h4></td>
                            </tr>
                    <%    while(rs.next()){
    ...
    <tr align="center">
        <form action="b_allow" method="post">
        <%String name=rs.getString(1);
        System.out.println(name);
        %>
        <td><h4><%=name%></h4></td>    
        <%String beneficiaryaccountno=rs.getString(2);%>
        <td><h4><input type="text" value="<%=beneficiaryaccountno%>" name="beneficiary" readonly style="width:83px;border: 0px;color: #0064ab;font: bold"/></h4></td>
         <%String userid=rs.getString(7);%>
         <td><h4><input type="text" value="<%=userid%>" name="userid" readonly style="width:83px;border: 0px;color: #0064ab;font: bold "/></h4></td>
        
         <td align="center"><input type="submit" value="Enable" style="background-color: #008dde;color: white"></td>
        </form>
    </tr>
...
//        String confirmpass=rs.getString(4);
...
//        hs.setAttribute("confirmpass", confirmpass);
//        hs.setAttribute("image", image);
                }
                    %>
                    </table></center>
                    <%
        ...
        {
         RequestDispatcher rd1=request.getRequestDispatcher("no_new_account.html");
...
<!--<center><input type="submit" value="ALLOW" style="background-color: #008dde;height:40px; width:120px;color: white" ></center>-->
</form>
