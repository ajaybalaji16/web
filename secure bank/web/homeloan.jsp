...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        ...
        <br></br>
                <form name="myForm" method="post" action="homeloan">
                ...
                <tr>
                    ...
                    <td><textarea rows="4"  name="address" cols="20" placeholder="present"></textarea>
                                 ...
                                 <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Purpose: </p></td>
                    <td><input type="text" name="purpose"/></td>
                </tr> 
                                 <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Monthly Income: </p></td>
                ...
                <tr>
                    ...
                    <td><input type="number" name="loanamount" /></td>
                                 ...
                                 <tr> <td>&nbsp;</td> </tr>
                       <tr>
                           <td> <p class="italic">Property Finalized: </p></td>
       ...
       <center>
  <table id="myTable">
      <tr><input type="submit" value="Enter" style="background-color: #008dde;height:40px; width:120px;color: white"></tr>
   </table>
       </center>
                     </form>
<!--      <div class="mainbar">-->
