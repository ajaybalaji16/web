...
function checkInp()
{
  var x=document.forms["form1"]["accountno"].value;
  if (isNaN(x)) 
  {
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="fixeddeposit.jsp"><span>Fixed Deposit</span></a></li>
           <li class="active"><a href="beneficiary.jsp"><span>Beneficiary</span></a></li>
...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        <center><h1>Beneficiary Added</h1></center>
                <center> <form name="form1" method="get" action="beneficiary" autocomplete="off">
                ...
                <%
                    ...
                    String accountno=(String)hs.getAttribute("accountno");
                      ...
                      <table>
                            <tr> <td>&nbsp;</td> </tr>
                            <tr><td><h3> Add Your transaction Account:</h3></td></tr>
                            <tr>
                                <td> <p class="italic">Name: </p> </td>
                    <td><input type="text" name="name" pattern="[a-zA-Z]+" onkeypress="return checkNum()" required=""/></td>
                </tr>
                            <tr>
                                <td> <p class="italic">Account No: </p> </td>
                                <td><input type="text" id="txtMobId" name="accountno" pattern="[0-9]{10}" onkeyup="return checkInp()"  maxlength="10" required=""/></td>
                </tr>
                       <tr> <td>&nbsp;</td> </tr>     
                <tr>
                    <td> <p class="italic">Email-id: </p></td>
                    <td><input type="text" name="email" id="email" onkeyup="if(this.length>255) this.value=this.value.substr(0, 255)" onblur="checkemail(this.value)" required="" onkeypress="return IsAccountNumber('txtMobId')"/></td>
                </tr>
                       <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Bank Name: </p></td>
                    <td><input type="text" name="bankname" onkeypress="return checkNum()" required=""/>
                    </td>
                </tr>
                       <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Branch Name: </p></td>
                    <td><input type="text" name="branchname" onkeypress="return checkNum()" required="">
...
<!--                <tr>
                    ...
                    <td><input type="text" name="amount" pattern="[0-9]+"/></td>
                      ...
                      <table>
                       <tr> <td>&nbsp;</td> </tr> 
                       <!--<tr> <td>&nbsp;</td> </tr>-->  
                        <tr><input type="submit" value="Add" onclick="ValidateEmail(document.form1.email)" style="background-color: #008dde;height:40px; width:120px;color: white"></tr>
                        </table>
                    <br></br>
...
//                        HttpSession hs=request.getSession();
                    String userid=(String)hs.getAttribute("accountno");
                      ...
                      ResultSet rs1=st1.executeQuery("select * from beneficiary where userid='"+userid+"' ");
                            ...
                            while(rs1.next())
                        {
                         ...
                         %>   
                          <form action="finaltransaction.jsp" method="get">
                        <tr align="center">
                            <td align="center"><h3><%=name%></h3></td>
                            <td  align="center" ><h3><input type="text" name="baccountno" value="<%=rs1.getString(2)%>" readonly style="border:0px;color: #0064ab"/></h3></td>
                            <td align="center"><h3><%=rs1.getString(6)%></h3></td>
                           
                            <td align="center"><button  value="view"  style="background-color: #008dde;height:20px; width:60px;color:white" id="user" name="edit" onclick="location.href='finaltransaction.jsp'">View</td>
                            <td align="center"><button  value="edit" style="background-color: #008dde;height:20px; width:60px;color: white"name="edit" onclick="location.href='edit.jsp'">Edit</td>
                            </form>
        <form name="form1" action="transaction" method="post">                           
        <td align="center"><input style="background-color: #008dde;height:20px; width:60px;color:white" type="submit" value="Delete" name="click" /></td>
