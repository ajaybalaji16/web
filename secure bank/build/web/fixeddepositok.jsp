...
<!--      <div class="slider">
    ...
    <div class="content_resize">
        <center> <h1>Fixed Deposit</h1></center><br>
                     <form name="myForm" method="post" action="fixeddeposit">
            <center><table width="400">
                ...
                <tr>
                    ...
                    <td><input type="text" name="phone" placeholder="xxxxxxrs" onkeypress="return isNumberkey(event)" required="" /></td>
                </tr>
                              <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td> <p class="italic">Pan Card No: </p></td>
                    <td><input type="text" name="pan" pattern="[a-zA-Z0-9]{10}" required="">
                    </td>
                </tr> 
                 <tr> <td>&nbsp;</td> </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="nominee" pattern="[a-zA-Z]+" required=""/></td>
                </tr> 
                   <tr> <td>&nbsp;</td> </tr>

                <tr>
                    <td> <p class="italic">Amount deposit: </p></td>
                    <td><input type="text" name="amount" pattern="[0-9]+" required=""/></td>
                </tr> 
                       <tr> <td>&nbsp;</td> </tr>
                           <tr>
                    <td> <p class="italic">Year: </p></td>
                    <td>
                         <select name="select" style="width:61%; padding-left:  39px;">
           ...
           <center>
               <%
                   HttpSession hs=request.getSession();
                    String amt=(String)hs.getAttribute("amount");
               %>
                    <h3 style="color: #33ccff">Rs.<%=amt%>  is successfully deposited!!</h3>
           </center>
       </center></form>
