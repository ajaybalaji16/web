...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
       <center> <form action="loan" method="post">
            <h1>Loan</h1> 
       <center>  
            <table id="myTable" width="400" >
                <tr><td align="center"> <p class="italic">Type of Loan </p></td><td><select name="entry">
                            <option value="home" ><p class="italic">Home </p></option>
                            <option value="education" size> <p class="italic">Education </p></option>
                        </select><td></tr><tr></tr>
            </table>
            </center>            
       <center>
           <table id="myTable" width="500">
                       <td align="center"><input type="submit" value="Enter" style="background-color: #008dde;height:40px; width:120px;color: white" ></td></tr></center>
            </table></form>
       </center>
<!--      <div class="mainbar">-->
<!--        <div class="article">
