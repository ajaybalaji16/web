...
<script type="text/javascript">
    ...
    function checkInp2()
{
  var x=document.forms["myform"]["Customer Id"].value;
  if (isNaN(x)) 
  {
...
<!--      <div class="searchform">
  ...
  <div class="content">
      <div>
        <div id="login">
             <center>
         <form action="login" name="myform" method="post" autocomplete="off">
<h2><strong>Welcome.</strong> Please login.</h2>

<fieldset>
    <p><input type='text' id="txtMobId1" name='Customer Id' value='Customer Id'  onBlur="if(this.value=='')this.value='Customer id'" onkeypress="return checkInp2()" onFocus="if(this.value=='Customer Id')this.value='' "required   autocomplete="off" maxlength="10"/></p>
    <p><input type="password"  name="pass" required value="Password" onBlur="if(this.value=='')this.value='Password'" onFocus="if(this.value=='Password')this.value=''" onkeyup="return IsAccountNumber('txtMobId1')"/></p>
