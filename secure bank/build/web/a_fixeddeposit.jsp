...
<!--        <form id="formsearch" name="formsearch" method="post" action="#">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="a_fixeddeposit.jsp"><span>Fixed Deposit</span></a></li>
...
<!--      <div class="slider">
    ...
    <div class="content_resize"> 
     ...
     <center><h1>View account who deposit fixed amount</h1></center>
     <br></br>
     <form>   
            <%
                    try{
