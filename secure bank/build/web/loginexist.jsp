...
<fieldset>
    <p><input type="text" name="user" pattern="[a-zA-Z]+"required value="Username" onBlur="if(this.value=='')this.value='Username'" onFocus="if(this.value=='Username')this.value='' "/></p>
...
<center><h3>You are already registered</h3></center>
         </form></center>
