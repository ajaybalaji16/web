...
<!--      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize"> 
        ...
        <br></br>
        <center> <form name="form1" action="transaction" method="post" autocomplete="off">
...
//                         System.out.println(viewaccount);%>
                            ...
                            <% 
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <input type="text" name="amount" onkeypress="return checkInp()" required="" />
                                 </td>
                             </tr>
                         </table>
                             <table>
                                 <center> <input type="submit" value="Click To Transfer" name="click" style="background-color: #008dde;height:40px; width:120px;color: white" onsubmit="return validateForm()"></input>
                             </table>
