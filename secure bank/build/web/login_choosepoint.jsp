...
<!--      <div class="slider">
 ...
 <center>
     <form name="myform" action="pixelcomparison" method="post" autocomplete="off">
                        <h1>Choose your image point</h1>
                        <br></br>
                        <center>  <table width="700px">
                                <tr align="center"> 
                                    <td> <input type="image" name="imag" src="login_choosepoint" width="167" height="117" border="3"></td>
                                    <!--<td><img id="image" src="login_choosepoint" width="167" height="117" onclick="document.getElementById('image').addEventListener('click', getXY);" border="3"></img></td>-->
<!--                                <form action="additionalImg" enctype="multipart/form-data">
                                    <table><tr>-->
                                            <!--<td></td><td><img src="additiona<lImg" width="167" height="117"></img></td></tr>-->
                                    <!--</table>-->
                            </table> </form>
