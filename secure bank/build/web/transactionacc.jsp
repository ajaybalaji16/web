  ...
  <div class="content">
    <div class="content_resize"> 
        <center><h1>Beneficiary Added</h1></center>
                <center> <form name="form1" method="post" action="beneficiary">
                ...
                <%
                    ...
                    <td><input type="text" name="accountno" pattern="[0-9]{10}" required=""/></td>
                </tr>
                       <tr> <td>&nbsp;</td> </tr>     
                <tr>
...
<!--                <tr>
                    ...
                    <td><input type="text" name="amount" pattern="[0-9]+"/></td>
                      ...
                      <center><h3>Check your Account no</h3></center>
                    <br></br>
...
//                        HttpSession hs=request.getSession();
                    String userid=(String)hs.getAttribute("accountno");
                        ...
                        <tr align="center">
                            ...
                            <td align="center"><button  value="<%=rs1.getString(2)%>"  style="background-color: #008dde;height:20px; width:60px;color:white" id="user" name="view" onclick="return x() "  >View</td>
                            <td align="center"><button  value="<%=rs1.getString(2)%>" style="background-color: #008dde;height:20px; width:60px;color: white"name="edit" onclick="return y()">Edit</td>
